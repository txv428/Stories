...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice: String) -> Story {
        if (userChoice == storyObject[storyNumber].choice1) {
            storyNumber = storyObject[storyNumber].choice1Destination
        }
        else {
            storyNumber = storyObject[storyNumber].choice2Destination
        }
        
        return storyObject[storyNumber]
    }
}
